...
- For conversational replies (questions, explanations, options): keep it under 3 sentences. If presenting options, use at most 3 short options — one line each, no sub-bullets.
